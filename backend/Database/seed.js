...
async function seed(){
  ...
  try {
    ...
    await pool.request().query(`
      INSERT INTO dbo.Suppliers (SupplierName, Phone, Email, Address) VALUES
    ...
    await pool.request().query(`
      INSERT INTO dbo.Warehouses (WarehouseName, Location) VALUES
    ...
    await pool.request().query(`
      INSERT INTO dbo.Staff (StaffName, Role, Phone, Email, HireDate, UserID) VALUES
    ...
    await pool.request().query(`
      INSERT INTO dbo.Products (ProductName, SKU, CategoryID, SupplierID, CostPrice, SellingPrice, IsActive) VALUES
    ...
    await pool.request().query(`
      INSERT INTO dbo.Customers (CustomerName, Phone, Email, Address) VALUES
    ...
    await pool.request().query(`
      INSERT INTO dbo.Inventory (ProductID, WarehouseID, Quantity, ReorderLevel) VALUES
      (1,  1, 45,  10),
      (1,  2, 30,  10),
      (2,  1, 200, 50),
      (2,  3, 150, 50),
    ...
    await pool.request().query(`
      INSERT INTO dbo.Orders (CustomerID, StaffID, OrderDate, Status, TotalAmount) VALUES
    ...
    await pool.request().query(`
      INSERT INTO dbo.Payments (OrderID, PaymentDate, PaymentMethod, Amount, Status) VALUES
    ...
    await pool.request().query(`
      INSERT INTO dbo.Returns (OrderItemID, ReturnDate, Quantity, Reason, RefundAmount) VALUES
